        ...
        <Container fluid className='px-5'>
          ...
          <Nav className="Nav justify-content-end" activeKey="/home">
              ...
              <NavDropdown title="MINISTRY" id="nav-dropdown">
                ...
                <NavDropdown.Item href="4.3">CHILDREN’S MINISTRY</NavDropdown.Item>
                <NavDropdown.Item href="4.3">CREATIVE ARTS</NavDropdown.Item>
                <NavDropdown.Item href="4.3">WORSHIP</NavDropdown.Item>
                <NavDropdown.Item href="4.3">USHERING</NavDropdown.Item>
                <NavDropdown.Item href="4.3">PRODUCTION TEAM</NavDropdown.Item>
              </NavDropdown>
              <NavDropdown title="EQUIPPING TRACK" id="nav-dropdown">
                <NavDropdown.Item href="4.1">REGISTRATION</NavDropdown.Item>
                <NavDropdown.Item href="4.2">TEACHERS LOUNGE</NavDropdown.Item>
                <NavDropdown.Item href="4.3">LIFE GUIDES</NavDropdown.Item>
              </NavDropdown>
          </Nav>
        </Container>
      </Navbar>
